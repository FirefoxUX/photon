...
Use buttons only to indicate a user action that updates the current screen or transmits information to the application (e.g., “Submit,” “Update Preferences”); see also “[links](#links)”.
